...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Lesson Two - First Exercise</title>
    <link rel="stylesheet" href="{{asset('css/lessontwo-a.css')}}"/>
  ...
  <body>
    ...
    <audio id="lessontwo-a" src="audios/lessontwo-a.mp3" onended="showButtons()"></audio>
    <div id="left">
      <img src="images/lessontwo-a-image.gif"/>
    </div>
    <div id="right">
      <div id="right-top">
        <div id="top-left">
          <img src="images/lessontwo-a-number.svg"/>
        </div>
        <div id="top-right">
