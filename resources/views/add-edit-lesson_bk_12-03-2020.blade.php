                                        ...
                                        <div class="image-section">
                                            ...
                                            @for($k=1 ; $k<=5 ; $k++)
                                                ...
                                                <div class="inline-flex">
                                                    ...
                                                    <input name="step{{$i}}_image[]" id="lesson_image{{$i}}" type="file" class="form-control-file file_upload file_transp">
                                                    <span class="hide">
                                                ...
                                                //dd($stepRow);
                                                    ...
                                                    //echo $courseId;
                                                    //dd($isStep);
                                                    //$imageResult = App\CourseFiles::getCourseImagesByCourseId($courseId);
                                                    //$imageRows = $imageResult->get();
                                                    //dd($imageRows);
