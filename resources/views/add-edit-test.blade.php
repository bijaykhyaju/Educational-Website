                        ...
                        <div class="table-container">
                            ...
                            <form class="add-edit-lesson" id="lesson-form" name="add-edit-lesson" enctype="multipart/form-data">
                                ...
                                <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="test_type" id="exampleSelect" class="form-control">
                                            @isset($lessonRows)
                                ...
                                <div class="position-relative row form-group img-cnt">
                                    ...
                                    <div class="col-sm-6 inline-flex" id="image_sec">
                                        <input name="test_image" id="test_image" type="file" class="form-control-file file_upload marg-right">                                        
                                        <span class="hide">
                                 ...
                                 <div class="position-relative row form-group">
                                    ...
                                    <div class="col-sm-6 inline-flex" id="audio_sec">
                                        <input name="test_audio" id="test_audio" type="file" class="form-control-file file_upload marg-right">                                        
                                        <span class="hide">
                                            <button type="button" class="mr-2 btn btn-outline-danger btn-sm remove-file">
                                                <i class="pe-7s-trash btn-icon-wrapper"> </i>
                                            </button>
  ...
  <script>
    ...
    $(document).ready(function(){
        ...
        $('#saveTestBtn').click(function(){
            ...
            $('#test_image').removeClass('err-input');
            $('#test_audio').removeClass('err-input');
